...
public class ActivityPrincipal extends AppCompatActivity implements FragmentCasa.EscuchadorDelFragmentInicio, FragmentCine.EscuchadorFragmentCine {

    private FragmentManager fragmentManager;
    public static String modoSeleccionado;   //TODO pasar a privado y hacer un getter y setter (privado)
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {               //botones de Toolbar
